...
1. **護符の効果の検討**
   ...
   「直接点の護符」を無くして別の効果にする→対象6個(沈着・冷静・慢心・残響・流星・誠実)の変更候補12案を洗い出し(詳細は`docs/shidasu/shidasu-direct-score-talismans-redesign.md`を参照)、6護符すべて案Bを採用して実装完了(2026-08-06)。詳細は`docs/superpowers/specs/2026-08-06-shidasu-direct-score-talismans-plan-b-design.md`を参照。

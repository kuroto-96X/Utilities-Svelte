export const site = {
  ...
  tools: [
    ...
    {
      href: "/investment/nisa-simple-calculator",
      label: "NISA年率計算",
      description: "NISAの損益率から運用年率を逆算するツール",
      category: 'investment',
    },
    {
      href: "/investment/nisa-detailed-calculator",
      label: "NISA詳細年率計算",
      description: "投資額の変更履歴からXIRRで運用年率を計算するツール",
      category: 'investment',
    },
    {
      href: "/investment/nisa-accumulation-simulator",
      label: "NISA積立シミュレーター",
